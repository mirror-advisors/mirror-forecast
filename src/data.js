...
export const P = {
  bg: "#0f1419", c1: "#181f2a", c2: "#1e2a38", bd: "#2a3a4a",
  g: "#34d399", gB: "#0d2e22", gM: "#065F46",
  r: "#fb7185", rB: "#2d1520", rM: "#881337",
  a: "#fbbf24", aB: "#2d2510",
  b: "#60a5fa", p: "#c4b5fd", t: "#2dd4bf",
  tx: "#e8edf4", tm: "#8899ab", td: "#566a80",
};
...
export const TIERS = {
  ...
  zho: { l: "Zoho-Commission-Only", c: "#0EA5E9" },
  ot: { l: "One-Time", c: P.a },
};
